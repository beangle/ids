...
val b_common = "org.beangle.commons" % "beangle-commons" % "5.6.28"
...
val b_web = "org.beangle.webmvc" % "beangle-webmvc" % "0.10.6"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.13"
