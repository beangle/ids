...
val b_common = "org.beangle.commons" % "beangle-commons" % "6.1.2"
...
val b_web = "org.beangle.webmvc" % "beangle-webmvc" % "0.14.7"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.24"
