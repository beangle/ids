...
val b_common = "org.beangle.commons" % "beangle-commons" % "6.0.6"
val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.1.8"
val b_cache = "org.beangle.cache" % "beangle-cache" % "0.1.19"
val b_security = "org.beangle.security" % "beangle-security" % "4.4.7"
val b_web = "org.beangle.webmvc" % "beangle-webmvc" % "0.14.0"
