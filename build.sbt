...
val b_common = "org.beangle.commons" % "beangle-commons" % "6.2.0"
val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.1.9"
val b_cache = "org.beangle.cache" % "beangle-cache" % "0.1.20"
val b_security = "org.beangle.security" % "beangle-security" % "4.4.15"
val b_web = "org.beangle.webmvc" % "beangle-webmvc" % "0.14.9"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.25"
