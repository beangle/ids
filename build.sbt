...
val b_data_jdbc = "org.beangle.data" %% "beangle-data-jdbc" % "5.6.2"
val b_cache_redis = "org.beangle.cache" %% "beangle-cache-redis" % "0.1.3"
val b_security_web = "org.beangle.security" %% "beangle-security-web" % "4.3.4"
val b_web_action = "org.beangle.web" %% "beangle-web-action" % "0.3.7-SNAPSHOT"
