...
ThisBuild / version := "0.3.19-SNAPSHOT"
...
val b_common = "org.beangle.commons" % "beangle-commons" % "5.6.17"
val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.0.2"
val b_cache = "org.beangle.cache" % "beangle-cache" % "0.1.9"
val b_security = "org.beangle.security" % "beangle-security" % "4.3.21"
val b_web = "org.beangle.web" % "beangle-web" % "0.4.12"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.8"
