...
val b_common = "org.beangle.commons" % "beangle-commons" % "5.6.26"
val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.0.9"
val b_cache = "org.beangle.cache" % "beangle-cache" % "0.1.13"
val b_security = "org.beangle.security" % "beangle-security" % "4.3.27"
val b_web = "org.beangle.webmvc" % "beangle-webmvc" % "0.10.3"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.12"
