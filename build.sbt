...
ThisBuild / version := "0.3.20-SNAPSHOT"
...
val b_common = "org.beangle.commons" % "beangle-commons" % "5.6.18"
val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.0.3"
val b_cache = "org.beangle.cache" % "beangle-cache" % "0.1.10"
val b_security = "org.beangle.security" % "beangle-security" % "4.3.22"
val b_web = "org.beangle.web" % "beangle-web" % "0.5.0"
val b_notify = "org.beangle.notify" % "beangle-notify" % "0.1.9"
